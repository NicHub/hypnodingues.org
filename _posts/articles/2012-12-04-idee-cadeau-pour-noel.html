...
excerpt:
---
<p align="justify"><img class="alignright" title="Jeu des quatre accords toltèques" src="{{ site.url }}/assets/jeucomplet.jpg" alt="Jeu des quatre accords toltèques" width="300" />Vient enfin de sortir en librairie (après des retards dus à la tempête Sandy...) le <em><strong>Jeu des Accords Toltèques </strong></em>co-écrit par Olivier Clerc et Marc Kucharz : un moyen formidable de mettre en pratique à plusieurs autour d’une table, de manière ludique, la puissance transformatrice de ces accords qui ont déjà changé la vie de millions de gens.</p>
...
<p><img class="alignnone" title="Jeu des quatre accords toltèques" src="{{ site.url }}/assets/quatuor.jpeg" alt="Jeu des quatre accords toltèques" width="800" height="533" /></p>
